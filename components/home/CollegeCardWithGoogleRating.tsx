...
export default function CollegeCardWithGoogleRating({
  college,
}: CollegeCardWithGoogleRatingProps) {
  ...
  return (
    <Card
      onClick={handleClick}
      className="bg-white text-black p-4 rounded-lg flex flex-row w-full items-start gap-2 cursor-pointer"
    >
      <Image
        src={college.image}
